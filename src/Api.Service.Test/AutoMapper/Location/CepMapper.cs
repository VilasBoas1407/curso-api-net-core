...
namespace Service.Test.AutoMapper.Location
{
    public class CepMapper : BaseTesteService
    {
        ...
        public void E_Possivel_Mapear_os_Modelos_Cep()
        {
            ...
            var cepDtoCreateResult = Mapper.Map<CepCreateResultDTO>(entity);
            ...
            var cepDtoUpdateResult = Mapper.Map<CepUpdateResultDTO>(entity);
            ...
            var cepDtoCreate = Mapper.Map<CepCreateDTO>(cepModel);
            ...
            var cepDtoUpdate = Mapper.Map<CepUpdateDTO>(cepModel);
