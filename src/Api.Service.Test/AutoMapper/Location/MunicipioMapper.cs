...
namespace Service.Test.AutoMapper.Location
{
    public class MunicipioMapper : BaseTesteService
    {
        ...
        public void E_Possivel_Mapear_os_Modelos_Municipio()
        {
            ...
            var userDtoCreateResult = Mapper.Map<MunicipoCreateResultDTO>(entity);
            ...
            var userDtoUpdateResult = Mapper.Map<MunicipioUpdateResultDTO>(entity);
            ...
            var userDtoCreate = Mapper.Map<MunicipioCreateDTO>(userModel);
